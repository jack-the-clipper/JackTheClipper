...
namespace JackTheClipperCommon.SharedClasses
{
    ...
    public class OrganizationalUnitSettings : UserSettings
    {
        ...
        public OrganizationalUnitSettings(Guid id, [NotNull] IReadOnlyCollection<Feed> feeds, IReadOnlyCollection<Source> availableSources, NotificationSetting notification, int notificationInterval) : base(id, feeds, notification, notificationInterval, 20)
        {
